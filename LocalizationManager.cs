...
namespace FasterHarvesting {
    ...
    internal class LocalizationManager {
        ...
        private const string PREFIX = "FH_";
        ...
        internal static void Load() {
            try {
                ...
                MelonLogger.Msg("[FasterHarvesting] Localization loaded.");
            } catch (System.Exception ex) {
                MelonLogger.Error("[FasterHarvesting] Failed to load localization: " + ex.Message);
            }
        }
        ...
        // Cache: UILabel + localization key, built when ModSettings GUI is created.
        ...
        internal static void BuildCache(Transform modTab) {
            ...
            // Find all UILocalize in the modTab whose key starts with FH_
            ...
            // Find all DescriptionHolder components whose Text is a FH_ key
            ...
            MelonLogger.Msg($"[FasterHarvesting] Cache: {s_labels.Count} labels, {s_descs.Count} descriptions.");
        }
        ...
        // Build cache after ModSettings GUI is constructed (Priority.Low = runs after ModSettings Postfix)
        ...
        // Re-apply translations whenever TLD commits a language change
        ...
        // Intercept Localization.Get for FH_ keys (handles UILocalize.OnLocalize calls)
        ...
        // Intercept DescriptionHolder.Text getter on every read
        [HarmonyPatch]
